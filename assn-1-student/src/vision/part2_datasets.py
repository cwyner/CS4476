...
def make_dataset(path: str) -> Tuple[List[str], List[str]]:
    ...
    # Put correct filepaths in correct arrays
...
class HybridImageDataset(data.Dataset):
    ...
    def __getitem__(self, idx: int) -> Tuple[torch.Tensor, torch.Tensor, int]:
        ...
        image_a = transforms.ToTensor()(PIL.Image.open(self.images_a[idx]))
        image_b = transforms.ToTensor()(PIL.Image.open(self.images_b[idx]))
